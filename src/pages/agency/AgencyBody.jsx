      ...
      <main className="max-w-7xl mx-auto py-8 pt-24">
        ...
        <div
          className="bg-white dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl border
            border-slate-200 dark:border-slate-800/50 p-5 mb-8 shadow-xl
        ...
        <div className="flex gap-1 mb-8 bg-slate-200/50 dark:bg-slate-900/50 p-1.5 rounded-xl w-fit">
          {['properties', 'about', 'reviews'].map((tab) => (
            <button
              ...
              className={`px-3.5 py-2 rounded-lg font-medium capitalize transition-all ${
                activeTab === tab
        ...
        {/* Tab Content */}
        {activeTab === 'about' && (
        <div className="bg-white dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-200 dark:border-slate-800/50 p-5 shadow-lg">
